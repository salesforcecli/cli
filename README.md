...
running command...
$ sf (--version|-v)
@salesforce/cli/2.41.0 linux-x64 node-v20.12.2
$ sf --help [COMMAND]
USAGE
  $ sf COMMAND
...
...
_See code: [@salesforce/plugin-trust](https://github.com/salesforcecli/plugin-trust/blob/3.6.7/src/commands/plugins/trust/verify.ts)_
