...
running command...
$ sf (--version|-v)
@salesforce/cli/2.70.4 linux-x64 node-v22.11.0
$ sf --help [COMMAND]
USAGE
  $ sf COMMAND
...
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/get/log.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/get/test.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/list/log.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/run.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/run/test.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.6.6/src/commands/apex/tail/log.ts)_
