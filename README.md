...
running command...
$ sf (--version|-v)
@salesforce/cli/2.95.3 linux-x64 node-v22.16.0
$ sf --help [COMMAND]
USAGE
  $ sf COMMAND
...
...
_See code: [@salesforce/plugin-trust](https://github.com/salesforcecli/plugin-trust/blob/3.7.100/src/commands/plugins/trust/verify.ts)_
