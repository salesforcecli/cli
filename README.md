...
running command...
$ sf (--version|-v)
@salesforce/cli/2.46.3 linux-x64 node-v20.14.0
$ sf --help [COMMAND]
USAGE
  $ sf COMMAND
...
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/analytics/generate/template.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/apex/generate/class.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/apex/generate/trigger.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/get/log.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/get/test.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/list/log.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/run.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/run/test.ts)_
...
_See code: [@salesforce/plugin-apex](https://github.com/salesforcecli/plugin-apex/blob/3.1.16/src/commands/apex/tail/log.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/lightning/generate/app.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/lightning/generate/component.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/lightning/generate/event.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/lightning/generate/interface.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/lightning/generate/test.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/assign/permset.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/assign/permsetlicense.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/create/user.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/display/user.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/generate/password.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/list/auth.ts)_
...
_See code: [@salesforce/plugin-limits](https://github.com/salesforcecli/plugin-limits/blob/3.3.11/src/commands/org/list/limits.ts)_
...
_See code: [@salesforce/plugin-limits](https://github.com/salesforcecli/plugin-limits/blob/3.3.11/src/commands/org/list/sobject/record-counts.ts)_
...
_See code: [@salesforce/plugin-user](https://github.com/salesforcecli/plugin-user/blob/3.5.12/src/commands/org/list/users.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/login/access-token.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/login/device.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/login/jwt.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/login/sfdx-url.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/login/web.ts)_
...
_See code: [@salesforce/plugin-auth](https://github.com/salesforcecli/plugin-auth/blob/3.6.19/src/commands/org/logout.ts)_
...
_See code: [@salesforce/plugin-marketplace](https://github.com/salesforcecli/plugin-marketplace/blob/1.2.11/src/commands/plugins/discover.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/project/generate.ts)_
...
_See code: [@salesforce/plugin-sobject](https://github.com/salesforcecli/plugin-sobject/blob/1.4.9/src/commands/schema/generate/field.ts)_
...
_See code: [@salesforce/plugin-sobject](https://github.com/salesforcecli/plugin-sobject/blob/1.4.9/src/commands/schema/generate/platformevent.ts)_
...
_See code: [@salesforce/plugin-sobject](https://github.com/salesforcecli/plugin-sobject/blob/1.4.9/src/commands/schema/generate/sobject.ts)_
...
_See code: [@salesforce/plugin-sobject](https://github.com/salesforcecli/plugin-sobject/blob/1.4.9/src/commands/schema/generate/tab.ts)_
...
_See code: [@salesforce/plugin-schema](https://github.com/salesforcecli/plugin-schema/blob/3.3.11/src/commands/sobject/describe.ts)_
...
_See code: [@salesforce/plugin-schema](https://github.com/salesforcecli/plugin-schema/blob/3.3.11/src/commands/sobject/list.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/static-resource/generate.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/visualforce/generate/component.ts)_
...
_See code: [@salesforce/plugin-templates](https://github.com/salesforcecli/plugin-templates/blob/56.2.10/src/commands/visualforce/generate/page.ts)_
